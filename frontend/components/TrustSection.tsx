const trustItems = [
  {
    ...
    description: "Every piece is carefully crafted and inspected to meet our high standards of quality.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description: "We deliver our jewellery safely to your doorstep anywhere in Bangladesh.",
  },
  {
    icon: (
      <svg
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          {trustItems.map((item) => (
            <div key={item.title} className="text-center">
              <div className="w-14 h-14 mx-auto mb-4 flex items-center justify-center text-gold border border-gold/20">
                {item.icon}
              </div>
